...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'isAuthorized' => \App\Http\Middleware\AuthAnyUser::class,
        'cors' => \App\Http\Middleware\Cors::class,
        'isSuper' => \App\Http\Middleware\SuperMiddleware::class,
        'isAdmin' => \App\Http\Middleware\AdminMiddleware::class,
        'isSingleUser' => \App\Http\Middleware\SingleUserMiddleware::class,
        'isConsultant' => \App\Http\Middleware\ConsultantMiddleware::class,
        'isInactive' => \App\Http\Middleware\InactiveMiddleware::class,
