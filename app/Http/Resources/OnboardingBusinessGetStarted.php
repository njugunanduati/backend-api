...
class OnboardingBusinessGetStarted extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return
            [
                ...
                'step_6' => $this->step_6,
                'step_6_date' => $this->step_6_date,
                'step_6_note' => $this->step_6_note,
                'step_7' => $this->step_7,
                'step_7_date' => $this->step_7_date,
                'step_7_note' => $this->step_7_note,
            ];
    }
}
