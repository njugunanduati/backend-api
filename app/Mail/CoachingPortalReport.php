...
class CoachingPortalReport extends Mailable
{
    ...
    public function build()
    {
        ...
        $greetings = '';
        if (isset($this->details['recipient_name']) && strlen($this->details['recipient_name']) > 0) {
            $greetings = 'Hi ' . $this->details['recipient_name'];
        }
        ...
        return $this
            ...
            ->view('emails.coaching_portal_report')
            ->with([
