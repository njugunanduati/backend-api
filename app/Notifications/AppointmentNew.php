...
class AppointmentNew extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject('New Flash Coaching Appointment - PAS')
                    ->from(env('EMAIL_FROM'), 'Profit Acceleration Software')
                    ->greeting('New Appointment.')
                    ->line('Your have a new Flash Coaching Appointment on '.$date.' created by '.$this->student->first_name .' '.$this->student->last_name.'.')
