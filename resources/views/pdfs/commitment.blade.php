...
<html>
  ...
  <body>
    ...
    <section class="notecontainer">
        <section class="box">
                <section class="subheading">Due: <span>{!! $due ?? '' !!}</span></section>
                <section class="subheading">Status: <span>{!! $status ?? '' !!}</span></section>
                <section class="heading">Task</section>
